...
class EventsHappeningTodayController extends SessionController
{
    public function index()
    {
        $data = [
            'title' => 'City Agenda | Events Happening Today',
            'currentpage' => 'eventshappeningtoday'
        ];
        return view('pages/admin/eventshappeningtoday', $data);
    }
    public function getData()
    {
        return datatables('events')
            ...
            ->where('DATE(events.eventdate)', date('Y-m-d'))
            ->make();
    }
}
