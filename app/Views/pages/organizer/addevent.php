                ...
                <div class="col-md-12 m-b-30">
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h4><i class="fa fa-calendar"></i> Add Event</h4>
                        </div>
                        <div class="ml-auto d-flex align-items-center">
                            <nav>
                                <ol class="breadcrumb p-0 m-b-0">
                                    ...
                                    <li class="breadcrumb-item active text-primary" aria-current="page">Add Event</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="category_id" name="category_id" class="form-control chosen-select" data-placeholder="Choose a category...">
                                        ...
                                        <option value="<?=$list['category_id'];?>"><?=$list['categoryname'];?></option>
                                        <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="shortdescription" id="shortdescription" placeholder="Enter Description" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="card card-statistics">
                                    ...
                                    <div class="float-right">
                                        <div class="form-group">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="singleEvent" name="eventtype" value="Single" class="custom-control-input" checked>
                                                <label class="custom-control-label" for="singleEvent">Single Event</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="recurringEvent" name="eventtype" value="Recurring" class="custom-control-input">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-4" id="dateField">
                                        ...
                                        <input type="date" class="form-control" name="eventdate" id="inputDate">
                                    </div>
                                    <div class="form-group col-md-4" id="startTimeField">
                                        <label for="inputStartTime">Starting Time</label>
                                        <input type="time" class="form-control" name="eventstartingtime" id="inputStartTime">
                                    </div>
                                    <div class="form-group col-md-4" id="endTimeField">
                                        <label for="inputEndTime">End Time</label>
                                        <input type="time" class="form-control" name="eventendingtime" id="inputEndTime">
                                    </div>
                        ...
                        <div class="card card-statistics">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="eventdescription" id="eventdescription" placeholder="Enter Content"></textarea>
                                </div>
                                <div id="mediaContent">
...
<script type="text/javascript" src="<?=base_url();?>assets/js/organizer/addevent.js"></script>